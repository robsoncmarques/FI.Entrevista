...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoBeneficiario : AcessoDados
    {
        ...
        internal DML.Beneficiario Consultar(long Id)
        {
            ...
            List<DML.Beneficiario> retorno = Converter(ds);
        ...
        /// <returns>True se o CPF já está cadastrado</returns>
        internal bool VerificarExistencia(string CPF, long idCliente)
        {
            ...
            DataSet ds = base.Consultar("FI_SP_VALIDACPFBENEFICIARIO", parametros);
        ...
        private List<DML.Beneficiario> Converter(DataSet ds)
        {
            ...
            if (ds != null && ds.Tables != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    DML.Beneficiario retorno = new DML.Beneficiario();
                    retorno.Id = row.Field<long>("Id");
                    retorno.IdCliente = row.Field<long>("IdCliente");
                    retorno.Nome = row.Field<string>("Nome");
                    retorno.CPF = row.Field<string>("CPF");
                    lista.Add(retorno);
                }
            }
